...
<body style="background-color: #009933;">
    <div class="login-page">
        ...
        <form class="login-form" id="loginForm" method="post">
            ...
            <div style="clear: both;"></div>
            <p style="margin-right: 25px;float:right">Nuk keni akoma account?<span><a style="color: #009933;text-decoration:none;padding-left:10px" href="register.php">Regjstrohu</a></span></p>
